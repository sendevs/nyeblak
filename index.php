    ...
    <div class="container">
        <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    <img src="logoo.png" class="hidden-xs">
                    <img src="logoo.png" class="visible-xs"><span class="sr-only">Nyeblak - go to homepage</span>
                </a>
            ...
            <div class="navbar-collapse collapse" id="navi  gation">
        ...
        <div class="same-height-row">
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Special for Mahasiswa USU</h3>
                    <p>Aplikasi ini di khususkan untuk informasi UMKM mahasiswa di sekitar USU</p>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <p>Aplikasi ini akan memberikan informasi lengkap mengenai menu makanan di Nyeblak dan juga Partner lainnya</p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
<div class="box text-center" data-animate="fadeInUp">
    <div class="container">
        <div class="col-md-12">
            <h3 class="text-uppercase"> nyeblak bekerja sama dengan partner lain. </h3>

            <p class="lead">Penasaran dengan partner kami? <a href="warung.php">Check our partner!</a>
            </p>
        </div>
    </div>
</div>
...
<!-- /#content -->
 ...
 <div id="copyright">
    <div class="container">
        <div class="col-md-6">
            <p class="pull-left">© nyeblak 2018</p>
        </div>
        <div class="col-md-6">
            <p class="pull-right">Alright Reserved by nyeblak
            </p>
        </div>
    </div>
</div>
